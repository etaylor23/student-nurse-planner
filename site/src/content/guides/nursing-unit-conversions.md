...
- **Same amount, different clothes.** 0.5 mg and 500 micrograms are identical. Prescriptions and stock labels often use different units for the same medicine, so convert to one unit *before* the [dose formula](/guides/nursing-drug-calculations), never during.
- **The invisible leading zero.** Write **0.5**, never .5, because a naked decimal point is easily missed, turning 0.5 into 5. (This is also why prescribing guidance prefers 500 micrograms over 0.5 mg in the first place.)
- **µg, mcg, micrograms.** Write **micrograms** in full. The abbreviations are misread as mg, a thousand-fold error waiting to happen.
- **Trailing zeros.** 5 mg, not 5.0 mg, because a missed point turns 5.0 into 50.
