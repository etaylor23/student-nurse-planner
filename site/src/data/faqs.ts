...
export const FAQS: Faq[] = [
  ...
  {
    q: "Is PlaceMate free?",
    a: "Yes. PlaceMate is free for student nurses. You can start straight away in demo mode on your device with no account needed, or create a free account to sync your data. There is no cost and no card required.",
    home: true,
  },
  {
