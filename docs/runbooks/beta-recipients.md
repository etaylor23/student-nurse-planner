...
| Chelsea   | `chelseappp@hotmail.co.uk`   | `inbound-consent` 2026-09-01 · `magic-link` 2026-09-02 · `invite-sent` 2026-09-02 | 2026-09-02 | invited | Hotmail. Student nurse at the University of Staffordshire; emailed hello@ on 2026-08-31 asking to join and offering to recommend us to other students. Consent-gated, no call: consented by email reply 2026-09-02, provisioned + magic link + `invite-sent` follow-up (bcc ellis@) all the same day. No `welcome-beta` — the consent flow uses `invite-sent` instead. Flagged the email text rendering small on her iPhone (fixed in `_shell` the same day) |
