...
| Chelsea   | `chelseappp@hotmail.co.uk`   | `inbound-consent` 2026-09-01 | — | inbound | Hotmail. Student nurse at the University of Staffordshire; emailed hello@ on 2026-08-31 asking to join and offering to recommend us to other students. Consent-gated, no call: **consented by email reply 2026-09-02** ("yes that's fine, more than happy to be in the beta") — ready to provision. BCC'd ellis@ + gmail on the send. Flagged the email text rendering small on her iPhone (fixed in `_shell` the same day) |
